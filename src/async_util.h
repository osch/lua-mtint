...
#ifndef MTINT_ASYNC_UTIL_H
#define MTINT_ASYNC_UTIL_H

/* -------------------------------------------------------------------------------------------- */

#define async_util_abort mtint_async_util_abort
...
#elif defined(MTINT_ASYNC_USE_WINTHREAD)
...
#define async_lock_init mtint_async_lock_init
void async_lock_init(Lock* lock);

/* -------------------------------------------------------------------------------------------- */

#define async_lock_destruct mtint_async_lock_destruct
...
#define async_mutex_init mtint_async_mutex_init
void async_mutex_init(Mutex* mutex);

/* -------------------------------------------------------------------------------------------- */

#define async_mutex_destruct mtint_async_mutex_destruct
...
#define async_mutex_wait mtint_async_mutex_wait
void async_mutex_wait(Mutex* mutex);

/* -------------------------------------------------------------------------------------------- */

#define async_mutex_wait_millis mtint_async_mutex_wait_millis
