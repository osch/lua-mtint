...
void mtint_async_lock_init(Lock* lock)
{
...
void mtint_async_lock_destruct(Lock* lock)
{
#if defined(MTINT_ASYNC_USE_PTHREAD)
...
void mtint_async_mutex_init(Mutex* mutex)
{
#if defined(MTINT_ASYNC_USE_PTHREAD)
...
void mtint_async_mutex_destruct(Mutex* mutex)
{
#if defined(MTINT_ASYNC_USE_PTHREAD)
...
void mtint_async_mutex_wait(Mutex* mutex) 
{
#if defined(MTINT_ASYNC_USE_PTHREAD)
...
bool mtint_async_mutex_wait_millis(Mutex* mutex, int timeoutMillis)
{
#if defined(MTINT_ASYNC_USE_PTHREAD)
